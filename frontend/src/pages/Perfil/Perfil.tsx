      ...
      <div className="profile-card antropometric-card">
        ...
        {dadosAntropometricos.peso ? (
            ...
            <div className="antropometric-grid">
              ...
              <div className="input-grupo">
                ...
                <div className="input-wrapper readonly">
                  ...
                  <input
                    type="text"
                    value={new Date(dadosAntropometricos.dataAvaliacao).toLocaleDateString('pt-BR')}
                    readOnly
                  />
                </div>
              </div>
            ...
            {imc && (
              <div className="imc-display">
                <div className="imc-info">
                  ...
                  <span className={`imc-classification ${getClassificacaoIMC(Number(imc)).toLowerCase().replace(/\s+/g, '-')}`}>
          ...
          <div className="no-data-message">
            ...
            <span>Os dados serão exibidos após sua próxima consulta médica</span>
          </div>
        )}
      </div>
    </div>
